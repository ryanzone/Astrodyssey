...
export default function Explore() {
  return (
    <div className="relative min-h-screen w-full bg-black overflow-x-hidden text-white">
      ...
      <div className="relative z-50 flex flex-col items-center justify-start pt-32 px-4 pb-40">
        <Transition delay={0.3}>
          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Explore the Cosmos</h1>
        ...
        <div className="z-40 w-full max-w-5xl px-2 mt-20">
          <SpaceNewsGallery />
        </div>
      </div>
    </div>
